...
class App extends Component {
    ...
    constructor(props)
    {
        ...
        Dialogflow.setConfiguration(
             '6a0a2c722827489aadb2e9bf789bcb66',Dialogflow.LANG_ENGLISH_GB
          );
...
query:{flex:1, flexDirection: 'column', alignSelf: 'flex-start', backgroundColor: '#ffffff', borderColor: '#000', borderRadius: 20},
answer:{flex:1,flexDirection: 'column', justifyContent:'flex-end',alignSelf: 'flex-start', marginLeft:20, backgroundColor: '#ffffff',borderColor: '#000',borderRadius: 20},
commands:{
